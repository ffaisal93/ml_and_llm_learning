...
- **[`61_large_scale_llm_systems/EFFICIENT_TRAINING_INFERENCE_PLAYBOOK.md`](../61_large_scale_llm_systems/EFFICIENT_TRAINING_INFERENCE_PLAYBOOK.md)** — the systems backdrop scaling laws live in.

## How to use this chapter

1. Read [`SCALING_LAWS_DEEP_DIVE.md`](SCALING_LAWS_DEEP_DIVE.md) straight through once.
