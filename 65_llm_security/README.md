...
- **[`07_llm_problems/HALLUCINATION_DETECTION_DEEP_DIVE.md`](../07_llm_problems/HALLUCINATION_DETECTION_DEEP_DIVE.md)** — the factuality slice of trust.
- **[`07_llm_problems/AGENT_IN_30_MIN.md`](../07_llm_problems/AGENT_IN_30_MIN.md)** — the agent loop the security model wraps around.
- **[`07_llm_problems/LLM_EVALUATION_DEEP_DIVE.md`](../07_llm_problems/LLM_EVALUATION_DEEP_DIVE.md)** — eval methodology overlaps with red-team eval methodology.
- **[`08_training_techniques/ALIGNMENT_DEEP_DIVE.md`](../08_training_techniques/ALIGNMENT_DEEP_DIVE.md)** — alignment is the model-level half of security.

## How to use this chapter

1. Read [`LLM_SECURITY_DEEP_DIVE.md`](LLM_SECURITY_DEEP_DIVE.md) straight through once.
...
4. Drill [`INTERVIEW_GRILL.md`](INTERVIEW_GRILL.md) — target 110+/135 before a frontier-lab security round.
