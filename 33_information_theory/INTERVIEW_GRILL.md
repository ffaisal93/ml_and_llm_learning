...
Closed-form solution to the RLHF objective: $\pi^* = \pi_{\text{ref}} \cdot \exp(r/\beta) / Z$. Solve for $r$ and substitute into Bradley-Terry. $Z$ cancels. Result is DPO loss. See [`08_training_techniques/ALIGNMENT_DEEP_DIVE.md`](../08_training_techniques/ALIGNMENT_DEEP_DIVE.md).
